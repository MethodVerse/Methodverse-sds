...
namespace methodverse::parameter
{
    ...
    public:
        ...
        // Non-const indexing → mutable reference proxy
        decltype(auto) operator[](std::size_t i) { return value_.at(i); }
        decltype(auto) operator[](std::size_t i) const { return value_.at(i); }
